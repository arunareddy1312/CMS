             ...
             <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Edit Admin Service</h4>                                                   
                </div>
                <div class="card-body">
                  <form method="post" action="http://localhost/CMS/admin/AdminService/update">
                     <?php
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">ClassName</label>
                          <input type="text" class="form-control" name="name" value="<?php echo $data['classname'] ?>">
                        </div>
                      </div>   
                      <div class="col-md-6">
                        <div class="form-group">
