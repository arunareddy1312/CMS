             ...
             <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Edit Admin Header</h4>                                                   
                </div>
                <div class="card-body">
                  <form method="post" action="http://localhost/CMS/admin/AdminHome/update_footer">
                    <?php
                    ...
                    <div class="row">                         
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <textarea class="form-control" rows="3" name="text" required="required"><?php echo $data['text'] ?></textarea> 
                        </div>
                      </div>                 
                    </div>                                                           
