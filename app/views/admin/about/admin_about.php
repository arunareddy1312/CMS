                      ...
                      foreach($result as $key=>$value){
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a class="btn btn-primary" id="edit" href="AdminAbout/edit/<?php echo $value['id'];?>">Edit</a>
                            <a class="btn btn-primary" onclick="return confirm('Are you sure Want To Delete It??')" id="delete" href="AdminAbout/delete/<?php echo $value['id'];?>">Delete</a>
                            <?php 
                              }else{
                            ?>
                            <a class="btn btn-primary" id="edit" href="AdminAbout/edit/<?php echo $value['id'];?>">Edit</a>
      ...
      <div class="modal" id="add" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <form method="post" action="AdminAbout/create">
