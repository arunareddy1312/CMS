             ...
             <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Edit Admin Contact</h4>                                          
                </div>
                <div class="card-body">
                  <form method="post" action="http://localhost/CMS/admin/AdminContact/update">
                     <?php
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <textarea class="form-control" rows="3" name="content" required="required"><?php echo $data['heading_content'] ?></textarea>    
                        </div>
                      </div>   
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Map Address</label>
                         <textarea class="form-control" rows="3" name="map_address" required="required"><?php echo $data['map_address'] ?></textarea>
                        </div>
                      </div>                   
                    </div>
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="location" value="<?php echo $data['location_address'] ?>" required="required">   
                        </div>
                      </div> 
                      <div class="col-md-4">
                        <div class="form-group">
