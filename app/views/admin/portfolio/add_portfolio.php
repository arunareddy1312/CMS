          ...
          <div class="row">   
             <div class="col-md-8">
              <div class="card">
                ...
                <div class="card-body">
                  <form method="post" action="http://localhost/CMS/admin/AdminPortfolio/create" enctype="multipart/form-data">           
                    <div class="row">
                      <div class="col-md-6">                       
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Filter Class (enter only these 3 class : filter-app/filter-card/filter-web)</label>
                          <input type="text" class="form-control" name="filter" required="required">
                        </div>
                      </div>                   
                    </div>
                    <div class="row">
