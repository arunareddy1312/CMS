             ...
             <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Edit Admin Portfolio</h4>                                       
                </div>
                <div class="card-body">
                  <form method="post" action="http://localhost/CMS/admin/AdminPortfolio/update" enctype="multipart/form-data">
                     <?php
                    ...
                    <div class="row">
                      <div class="col-md-6">                       
                          ...
                          <img class="img" width="120px" src="http://localhost/CMS/<?php echo $data['image'];?>" />
                          <input type="file" class="form-control" name="photo" value="<?php echo $data['image'];?>">       
                      </div>   
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Filter Class</label>
                          <input type="text" class="form-control" name="filter" value="<?php echo $data['filter_class'];?>" required="required">
                        </div>
                      </div>                   
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="heading" value="<?php echo $data['heading'];?>" required="required">
                        </div>
                      </div>  
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Small Text</label>
                          <input type="text" class="form-control" name="text" value="<?php echo $data['text'];?>" required="required">
                        </div>
                      </div>                                  
                    </div>                                       
                    <button type="submit" class="btn btn-primary pull-right">Update Portfolio</button>
